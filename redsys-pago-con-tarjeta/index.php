...
<title>Pagar con tarjeta de forma segura</title>
...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="#">PASARELA DE PAGOS - CONTROL</a></li>
          <li class="breadcrumb-item active" aria-current="page">Pagar con tarjeta de forma segura</li>
        </ol>
    </nav>
...
if (isset($_POST['submitPayment'])) {
    ...
    $name =$_REQUEST['nombre'].''; //cambiar este dato
    $code =$_REQUEST['codigo'].''; //cambiar este dato
...
<div class="jumbotron">
    ...
    <form class="form-amount" action="index.php" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" id="amount" name="amount" class="form-control" value="<?php echo $precio; ?>">

        </div>

         <div class="form-group">
            <label for="amount">NOMBRE DE CLIENTE</label>
            <input type="text" id="nombre" name="nombre" class="form-control" value="<?php echo $nombre; ?>">
        </div>


         <div class="form-group">
            <label for="amount">NUMERO DE TARJETA</label>
            <input type="text" id="numero" name="numero" class="form-control" value="<?php echo $numero;?>">

        <div class="form-group">
            <label for="amount">CODIGO DE TARJETA</label>
            <input type="text" id="codigo" name="codigo" class="form-control" placeholder="DIGITE 3 DIGITOS DE LA TARJETA">
        ...
        <div class="col-lg-12">
            <div class="pull-right">
                <a href="https://www.jose-aguilar.com/blog/como-implementar-una-pasarela-de-pago-mediante-tarjeta-de-credito-con-php/" class="btn btn-secondary">
                    <i class="fa fa-reply"></i> VER DOCUMENTACION DE EJEMPLO PARA LA CLASE
                </a>
                <a href="#" class="btn btn-primary">
                    <i class="fa fa-download"></i> CONTROL DE PASARELA
                </a>
            </div>
        </div>
    </div>
