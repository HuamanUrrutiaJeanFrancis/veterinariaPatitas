...
<article>
  ...
  <div id="contenido">
    <div class="machupicchu">
      <div class="columna">
        <span class="subtitulo">Conozca</span>
        <strong>
        <h2>Nuestra veterinaria</h2>
        <p>
          ,
          Fundada el 20/01/2023, nuestra veterinaria patitas tiene la mision de poner en adopcion a todas las mascotas sin hogar en el, ven y ayudanos a cumplir nuestra mision, conocenos.!
        </p>
        <strong>
      </div>
      <div class="columna">
...
<footer>
  ...
  <div class="columna tercera">
    ...
    <ul>
      ...
      <li>Facebook: /PATITAS-VETERINARIA</li>
    </ul>
  </div>
</footer>
